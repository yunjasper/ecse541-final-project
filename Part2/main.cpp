...
volatile unsigned int software_cycles = 0;
...
int sc_main(int argc, char* argv[])
{
    ...
    debug_log_file.open ("log_part2.txt", ofstream::trunc); // open in truncate mode, delete previous contents

    // print info about this program
    cout << "\n\nECSE 541: MPSoC Design, HW2 -- Part 2" << endl;
    cout << "Software-Hardware Partitioned Matrix-Matrix Multiplication" << endl;
    debug_log_file << "ECSE 541: MPSoC Design, HW2 -- Part 2" << endl;
    ...
    cout << "[main] final memory contents at addrC of each loop printed to log_part2.txt." << endl;
